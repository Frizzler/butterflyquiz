...
public class Frage008Activity extends AppCompatActivity {
    ...
    public void addListenerOnImage1() {
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                loesung.setText("Richtig! Das ist ein Schmetterlingshaft; Schmetterlingshafte gehören zur Ordnung der Netzflügler.");
                Button weiterbutton = (Button) findViewById(R.id.weiterbutton);
                weiterbutton.setVisibility(View.VISIBLE);
                imageView1.setImageResource(R.drawable.frage008_1_checked);
    ...
    public void addListenerOnImage2() {
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                TextView loesung = (TextView) findViewById(R.id.loesung);
                loesung.setText("Leider nicht richtig.\r\nDer Hornklee-Glasflügler sieht aus wie eine Wespe, gehört aber zu den Schmetterlingen.");
                imageView2.setImageResource(R.drawable.frage008_2_checked);
                fehler++;
                if (soundistaktiviert) {
    ...
    public void addListenerOnImage3() {
        ...
        imageView3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                TextView loesung = (TextView) findViewById(R.id.loesung);
                loesung.setText("Leider nicht richtig.\r\nAuch Nachtfalter gehören zu den Schmetterlingen, hier der Erlen-Rindenspanner.");
                imageView3.setImageResource(R.drawable.frage008_3_checked);
                fehler++;
                if (soundistaktiviert) {
                    MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.richerlandtvbadbeepincorrect);
                    mp.start();
    ...
    public void addListenerOnImage4() {
        ...
        imageView4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                TextView loesung = (TextView) findViewById(R.id.loesung);
                loesung.setText("Leider nicht richtig.\r\nDas Landkärtchen ist einwandfrei ein Schmetterling.");
                imageView4.setImageResource(R.drawable.frage008_4_checked);
                fehler++;
                if (soundistaktiviert) {
                    MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.richerlandtvbadbeepincorrect);
                    mp.start();
    ...
    public void sendMessage(View view) {
        Intent intent = new Intent(this, Frage009Activity.class);
